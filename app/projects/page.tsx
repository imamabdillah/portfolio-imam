...
export default function ProjectsPage() {
  ...
  const featured = allProjects.find(
    (project) => project.slug === "e-procurement"
  )!;
  const top2 = allProjects.find(
    (project) => project.slug === "kasir-foodcourt"
  )!;
  const top3 = allProjects.find((project) => project.slug === "desa-cantik")!;

  const onlineVoting = allProjects.find(
    (project) => project.slug === "voting"
  )!;
    ...
    <div className="relative pb-16">
      ...
      <div className="px-6 pt-20 mx-auto space-y-8 max-w-7xl lg:px-8 md:space-y-16 md:pt-24 lg:pt-32">
        ...
        <div className="grid grid-cols-1 gap-4 mx-auto lg:mx-0 md:grid-cols-3">
          {[onlineVoting, phoneStore, skd, ...sorted].map(
            (project) =>
              project && (
                <Card key={project.slug}>
                  <Link href={`/projects/${project.slug}`}>
